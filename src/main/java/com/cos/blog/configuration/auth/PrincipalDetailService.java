...
public class PrincipalDetailService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
		//객체에 userRepository의 findByUsername으로 계정 검사 및 조회를 진행한 뒤
		//스프링 시큐리티 내부적으로 패스워드가 동일 해쉬 암호화 후 비교 통과까지 성공하면
		//스프링 시큐리티 세션에 아래와 같이 PrincipalDetail로 감싸진 principal이 등록된다.
